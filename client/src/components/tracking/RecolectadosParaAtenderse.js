...
const RecolectadosParaAtenderse = () => {
  ...
  if (tareasExternas) {
    ...
    var tareasFiltradas = tareasExternas.tareasExternasActivas.filter(tareaExterna => (
          parseInt(tareaExterna.estado_tarea.id_estado_tarea) === STATUS_TAREA.RECOLECTADO_PARA_ATENDERSE &&
  ...
  return (
    <ListaTareasExternas
      ...
      titulo='Recoledtados para Atenderse'
      siguienteEstado={STATUS_TAREA.RECIBIDO_PARA_ATENDERSE}
