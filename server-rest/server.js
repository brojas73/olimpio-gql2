...
const main = async() => {
    ...
    app.use('/api/tipos-trabajo', (_, res) => {
    ...
    app.use('/api/tipos-servicio', (_, res) => {
    ...
    app.use('/api/estados-tarea', (_, res) => {
    ...
    app.use('/api/estados-servicio-domicilio', (_, res) => {
    ...
    app.get('/api/tareas-externas', (_, res) => {
        const q = `
            select   te.id_tarea_externa,
                    te.id_sucursal_origen,
                    te.ticket,
    ...
    app.get('/api/servicios-domicilio', (_, res) => {
        const q = `
    ...
    app.get('/api/servicios-domicilio-activos', (_, res) => {
        const q = `
            select   sd.id_servicio_domicilio,
                    sd.tipo_servicio,
                    sd.id_sucursal,
    ...
    app.get('/api/servicios-domicilio-por-pagar', (_, res) => {
        const q = `
            select   sd.id_servicio_domicilio,
                    sd.tipo_servicio,
                    sd.id_sucursal,
    ...
    // https.createServer(app).listen(port, () => console.log(`API is running on port ${port}`));
